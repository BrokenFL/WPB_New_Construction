...
export const answerEngineFaq = [
  ...
  },
  {
    ...
    "answer": "Use public pricing only as a starting frame. Current source notes show Olara from roughly $1.7M in official fact material, Alba starting just under $3M, Shorecrest from about $3M, Ritz-Carlton from about $3M in current reviewed project material, Mandarin Oriental from $3.5M, Maison d'Or from $5.7M, NORA House from the low $2Ms on the current official site with March 2026 reporting around $2M to $6.5M, The Berkeley from $2M to over $10M on the current official site, Banyan Tree reporting around $1.9M, and South Flagler House's current official inquiry and availability flow starting at about $6M with materially higher live ranges above that. The real answer is always line, floor, view, terrace, parking, and release phase.",
...
export const projectFacts = [
  ...
  },
  {
    ...
    "facts": {
      ...
      "completion": "Topped off in April 2024 and closings were reported underway in July 2025; request current resale availability and building confirmation",
  ...
  },
  {
    ...
    "conflicts": [
      ...
      "Pricing availability varies by date, but the current official inquiry and availability surfaces begin at about $6M."
    ],
    "gaps": [
  ...
  },
  {
    ...
    "conflicts": [
      "Same full-project count conflicts as north tower; pricing availability varies by date, but the current official inquiry and availability surfaces begin at about $6M."
    ],
    "gaps": [
