...
export const projectCardDataById = Object.fromEntries([
  ...
  ["maison-dor", ["Maison d'Or", "Pre-Construction Sales", "Yes", "Late 2028 target", "Boutique South Flagler luxury with 39 residences, pricing from $5.7M, and a rare smaller-scale profile for buyers watching the next wave of waterfront new construction."]],
  ...
  ["mandarin-oriental", ["Mandarin Oriental Residences", "Approved", "Yes", "Timing to confirm", "Mandarin Oriental branded waterfront living planned for North Flagler with 87 residences, private elevators, wraparound terraces, and a long-horizon luxury play for brand-focused buyers."]],
  ...
  ["fern-and-gardenia-related-ross-fern-street", ["Residences at 464 Fern", "Municipal Review", "No", "TBD", "Related Ross proposes 194 residences in a 25-story downtown tower with two- to four-bedroom layouts. The June 2026 plan remains under city review."]],
