...
routes.push({id:'north-flagler',path:'/corridors/north-flagler/',title:'North Flagler New Construction Condos | Compare & Floor Plans',description:'Compare North Flagler condos including Olara and Ritz-Carlton: released floor plans, waterfront settings, active sales and buyer guidance before a gallery visit.'});
