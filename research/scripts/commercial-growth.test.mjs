...
test('static Buildings listings precede educational guidance', () => {
  const html = renderCommercialDocument(fixture('buildings'), 'buildings');
  assert.ok(html.indexOf('Existing project') < html.indexOf('data-commercial-guide="buildings"'));
});
